...
class Listing extends WP_List_Table
{
    ...
    function column_cb($item)
    {
        return sprintf(
            ...
            /*$2%s*/
            $item->slider_id               //The value of the checkbox should be the record's id
        );
    }
    ...
    function get_sortable_columns()
    {
        $sortable_columns = array(
            'title'        => array('slider_name', true),     //true means it's already sorted
    ...
    function usort_reorder($a, $b)
    {
        $a = get_object_vars($a);
        $b = get_object_vars($b);
        $orderby = (!empty($_REQUEST['orderby'])) ? $_REQUEST['orderby'] : 'slider_id'; //If no sort, default to title
